            ...
            for start_index in start_indexes:
                for end_index in end_indexes:
                    ...
                    if token_is_max_context is not None and not token_is_max_context.get(str(start_index), False):
                        continue
                    try:
                        a,b = offset_mapping[start_index][0], offset_mapping[end_index][1]
                    except:
                        # print("xxxxxxxxx:", feature_index, example_index, start_index, end_index, len(offset_mapping), len(offset_mapping[start_index]))

                        # if len(offset_mapping[start_index]) < 2 or len(offset_mapping[end_index]) < 2:
                        #     continue
                        continue                        
